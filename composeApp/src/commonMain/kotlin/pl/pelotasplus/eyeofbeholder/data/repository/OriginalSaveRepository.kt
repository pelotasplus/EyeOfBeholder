 ...
 */
interface OriginalSaveRepository {
    suspend fun loadOriginalSave(name: String): Result<OriginalSave>
}

class OriginalSaveRepositoryImpl(
    private val resourceRepository: ResourceRepository,
) : OriginalSaveRepository {

    override suspend fun loadOriginalSave(name: String): Result<OriginalSave> = runCatching {
        OriginalSave.read(resourceRepository.readResource("files/$name"))
    }
